...
def combinations(input_list):
    ...
    Given a list of objects, return all possible pairs of those objects as a
    list of tuples, regardless of order. Avoid nested for-loops if possible.
    
    e.g, [A, B, C] -> [(A, B), (B, C), (A, C)]
    '''
