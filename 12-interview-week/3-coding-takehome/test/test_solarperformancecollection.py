...
class TestSolarPerformance(unittest.TestCase):
    ...
    def test_percentile(self):
        ...
        percentile = set(self.spc.percentile(25))
        self.assertEqual(percentile, {1.18652810676406, 1.11151164379285})
    ...
    def test_top(self):
        ...
        top3 = self.spc.top(3)
        actual = [{'systemname': 'Sleepy',
                   'lifetimeperformance': 1.18652810676406},
                  {'systemname': 'Happy',
                   'lifetimeperformance': 1.11151164379285},
                  {'systemname': 'Doc',
                   'lifetimeperformance': 1.10329187448733}]
        self.assertEqual(top3, actual)
